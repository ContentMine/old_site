...
(function($){
    $.fn.graphview = function(options) {
        ...
        var defaults = {
            ...
            "searchhintline": "type search terms and click enter to search, choose a suggestion type to get search term hints",
        ...
        defaults.uibindings = function() {
            ...
            $('.query_string', obj).select2({
                "formatNoMatches": function() { return options.searchhintline;},
                "tags": function(q) {
